...
from SMT_VLSI import OptimalVLSI
...
def parse_args():
    ...
    argpars.add_argument("--output_log", "-log", type=str,
        help="Path to log file", default=os.path.join("SMT","out","log.txt"))
...
def solve_instance(problem, 
    ...
    if verbose:
        ...
        print()
    solution = problem.solve(draw_best=False)
